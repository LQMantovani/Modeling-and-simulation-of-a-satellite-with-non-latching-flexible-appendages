function [M, Qc, Q, Cq1, Cq2]=Generalized_matrices_Embedded(i, Bodies, omega, B, C321, C32, ArotB_I, n_B, g_B, U_mola_vec, Q1, R, Rp)
%//////////////////////////////////////////////////////////////////%
...
%Cq1: Jacobian of the contraint equations associated with body i
%Cq2: Jacobian of the contraint equations associated with body j
%//////////////////////////////////////////////////////////////////%
...
if Bodies.B(i).nflex == 0
    ...
    Ra = [0;0;-1];
    Rb = C321(:,:,i)*Ra;
    Qg = 3*n_B(i)^2*cross(Rb,Itt*Rb)*0;
...
if i ~= 1
    ...
    Cq1(1:3,1:3) = -[1 0 0;0 1 0;0 0 1];   %Always in this position, since it is the constraint associated with the first body
    Cq1(1:3,4:6) = -k_1*Gb_1;              %Always in this position, since it is the constraint associated with the first body
    Cq2(1:3,1:3) = [1 0 0;0 1 0;0 0 1];
    Cq2(1:3,4:6) = k_i*Gb_i;
    
    
    %Translation constraint forces
    K = Bodies.System.K_p;
